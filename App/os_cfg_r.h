...
#define OS_CFG_H
                                       ...
                                       /* ---------------------- MISCELLANEOUS ----------------------- */
#define OS_APP_HOOKS_EN           0u   //禁用钩子函数/* Application-defined hooks are called from the uC/OS-II hooks */
...
#define OS_DEBUG_EN               0u   //禁用调试模式/* Enable(1) debug variables                                    */
...
#define OS_TASK_SW_HOOK_EN        1u   /*     Include code for OSTaskSwHook()                          */
                                       ...
                                       /* ----------------------- EVENT FLAGS ------------------------ */
#define OS_FLAG_EN                0u   //禁用信号量集/* Enable (1) or Disable (0) code generation for EVENT FLAGS    */
...
#define OS_FLAGS_NBITS           16u   /* Size in #bits of OS_FLAGS data type (8, 16 or 32)            */
                                       ...
                                       /* -------------------- MESSAGE MAILBOXES --------------------- */
#define OS_MBOX_EN                1u   //禁用邮箱/* Enable (1) or Disable (0) code generation for MAILBOXES      */
...
#define OS_MBOX_QUERY_EN          1u   /*     Include code for OSMboxQuery()                           */
                                       ...
                                       /* --------------------- MEMORY MANAGEMENT -------------------- */
#define OS_MEM_EN                 0u   //禁用内存管理/* Enable (1) or Disable (0) code generation for MEMORY MANAGER */
#define OS_MEM_NAME_EN            1u   /*     Enable memory partition names                            */
#define OS_MEM_QUERY_EN           1u   /*     Include code for OSMemQuery()                            */


                                       /* ---------------- MUTUAL EXCLUSION SEMAPHORES --------------- */
#define OS_MUTEX_EN               0u   //禁用互斥信号量/* Enable (1) or Disable (0) code generation for MUTEX          */
...
#define OS_MUTEX_QUERY_EN         1u   /*     Include code for OSMutexQuery()                          */
                                       ...
                                       /* ---------------------- MESSAGE QUEUES ---------------------- */
#define OS_Q_EN                   0u   //禁用队列/* Enable (1) or Disable (0) code generation for QUEUES         */
...
#define OS_Q_QUERY_EN             1u   /*     Include code for OSQQuery()                              */
                                       ...
                                       /* ------------------------ SEMAPHORES ------------------------ */
#define OS_SEM_EN                 0u   //禁用信号量/* Enable (1) or Disable (0) code generation for SEMAPHORES     */
...
#define OS_TIME_TICK_HOOK_EN      1u   /*     Include code for OSTimeTickHook()                        */
                                       ...
                                       /* --------------------- TIMER MANAGEMENT --------------------- */
#define OS_TMR_EN                 0u   //禁用定时器/* Enable (1) or Disable (0) code generation for TIMERS         */
